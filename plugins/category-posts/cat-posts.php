...
<div class="post-date"><i class="icon-sprite icon-plus-rightarrow"></i><!-- inforance’Ç‹L --><?php the_time("j.n.Y"); ?></div>    
			<a class="post-title" href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent link to <?php the_title_attribute(); ?>"><?php the_title(); ?></a><br class="clearfix" />
			...
			<p class="post-date"><?php the_time("j.n.Y"); ?></p>
			<?php endif; ?>
			
			<?php if ( $instance['excerpt'] ) : ?>
			<div class="post-date"><!-- inforance•ÏX p¨div‚Ö --><?php the_excerpt(); ?></div>
			<?php endif; ?>
